...
The dictionary is an *output* of the pipeline, not a document maintained beside it.
...
> **The hardest question this design has to answer** is whether any predictor accidentally
> draws on information dated after day *t*. The pipeline simulates standing at the close of
> day *t* with no knowledge of the future, rebuilds each feature from scratch, and checks
> that it matches the stored value. Look-ahead bias is tested, not asserted.
